...
class TestFormatDuration:
    def test_standard(self):
        from autoflux_plugin_youtube.api import format_duration
...
class TestChunked:
    def test_even_split(self):
        from autoflux_plugin_youtube.api import chunked
...
class TestExtractVideoId:
    def test_standard_watch_url(self):
        from autoflux_plugin_youtube.api import extract_video_id
...
class TestBuildVideoUrl:
    def test_normal_video(self):
        from autoflux_plugin_youtube.api import build_video_url
...
class TestParseChannelHint:
    def test_channel_id(self):
        from autoflux_plugin_youtube.api import parse_channel_hint
...
class TestVideosList:
    ...
    async def test_calls_pool_request(self):
        from autoflux_plugin_youtube.api import videos_list
        mock_pool = AsyncMock()
...
class TestChannelsList:
    ...
    async def test_by_id(self):
        from autoflux_plugin_youtube.api import channels_list
        mock_pool = AsyncMock()
